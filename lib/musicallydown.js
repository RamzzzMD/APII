...
/**
 * Expert Web API Tool: MusicallyDown Reconstructed Downloader
 * Target: https://musicaldown.com
 */
async function download(tiktokUrl) {
    ...
    try {
        ...
        const inputUrlName = $('input[name^="_"]').first().attr('name'); 
